...
import { SunIcon, MoonIcon, LogoutIcon, ShieldIcon } from '../icons';

interface HeaderProps {
  isDarkMode: boolean;
  toggleDarkMode: () => void;
  onLogout: () => void;
  onToggleSafetyModule: () => void;
}

const Header: React.FC<HeaderProps> = ({ isDarkMode, toggleDarkMode, onLogout, onToggleSafetyModule }) => {
  return (
    <header className="bg-theme-light-gray dark:bg-theme-dark-secondary p-4 shadow-md sticky top-0 z-10">
      <div className="max-w-4xl mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          <button
            onClick={onToggleSafetyModule}
            className="p-2 rounded-full bg-accent-purple-light dark:bg-accent-purple-dark-bg text-accent-purple-text dark:text-accent-purple-dark-text focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent-purple dark:focus:ring-offset-theme-dark-secondary"
            aria-label="Open Safety Module"
          >
