...
// Using a generic props type for all icons to simplify
type IconProps = {
  className?: string;
  title?: string; // For accessibility
};

export const SpectrumIcon: React.FC<IconProps> = ({ className }) => (
...
export const SolarIcon: React.FC<IconProps> = ({ className, title }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
